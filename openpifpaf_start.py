...
img = cv2.imread("image/openpifpaf_sample.jpeg")
...
for pred in predictions:
    ...
    # print(center_shoulder, center_hip)
    cv2.circle(img, center=center_shoulder, radius=2, color=(222, 222, 0), thickness=-1)
    cv2.circle(img, center=center_hip, radius=2, color=(100, 100, 0), thickness=-1)
    cv2.line(img, pt1=center_shoulder, pt2=center_hip, color=(123, 123, 0), thickness=3)
    # 角度
